...
public struct MinMax
{
  ...
  public float Min { get => this.min; set => this.min = value; }

  public float Max { get => this.max; set => this.max = value; }

  public float RandomValue { get => UnityEngine.Random.Range(this.min, this.max); }
